...
// Source: http://www.bacnet.org/VendorID/ (via nmap bacnet-info.nse)
// Complete vendor registry (IDs 0-1212)
var vendorNames = map[uint16]string{
	...
	886:  "DCC Dynamics",
	887:  "B.E.G. Bruck Electronic GmbH",
	...
	935:  "Ingenieurburo H. Lertes GmbH & Co. KG",
...
// If the vendor ID is not in the registry, returns "unknown (ID: N)".

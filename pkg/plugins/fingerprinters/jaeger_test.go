...
<body>
  <div id="jaeger-ui-root"></div>
		...
		},
		{
			...
			body:               `<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Jaeger UI</title><base href="/"><script>function getJaegerVersion(){const DEFAULT_VERSION={'git_commit':'','git_version':'','build_date':''};const JAEGER_VERSION={"gitCommit":"abc123","gitVersion":"v1.35.0","buildDate":"2024-01-15T10:30:00Z"};return JAEGER_VERSION;}</script></head><body><div id="jaeger-ui-root"></div></body></html>`,
			wantVersion:        "1.35.0",
